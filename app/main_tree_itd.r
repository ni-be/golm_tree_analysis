...
las <- readLAS("/home/nibe/PROJECTS/golm_tree_analysis/app/test2_filtered.las", select = "xyzr") #, filter = "-keep_first, -drop_z_below 20, -drop_z-above 40")
las <- segment_trees(las, li2012(dt1 = 1.5, dt2 = 2, R = 2, Zu = 15, hmin = 2, speed_up = 2))


# Point-to-raster 2 resolutions
chm_p2r_05 <- rasterize_canopy(las, 2, p2r(subcircle = 0.2), pkg = "terra")
chm_p2r_1 <- rasterize_canopy(las, 2, p2r(subcircle = 0.2), pkg = "terra")
